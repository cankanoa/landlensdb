...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2026-03-13
        git sha              : $Format:%H$
        copyright            : (C) 2026 by Kanoa Lindiwe LLC
...
class Landlensdb:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Landlensdb')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Landlensdb', message)
    ...
    def initGui(self):
        ...
        icon_path = os.path.join(self.plugin_dir, 'landlensdb.png')
        self.add_action(
            icon_path,
